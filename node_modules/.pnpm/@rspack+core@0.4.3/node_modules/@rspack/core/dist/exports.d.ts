...
export declare const config: {
    getNormalizedRspackOptions: (config: {
        ...
        plugins?: (import("./config").RspackPluginInstance | import("./config").RspackPluginFunction)[] | undefined;
        devServer?: import("./config").DevServer | undefined;
        builtins?: import("./builtin-plugin").Builtins | undefined;
        module?: {
            defaultRules?: ("..." | import("./config").RuleSetRule)[] | undefined;
            rules?: ("..." | import("./config").RuleSetRule)[] | undefined;
            parser?: {
                asset?: {
                    dataUrlCondition?: {
                        maxSize?: number | undefined;
