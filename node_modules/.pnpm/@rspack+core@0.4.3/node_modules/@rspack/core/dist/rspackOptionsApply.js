...
const WorkerPlugin_1 = require("./builtin-plugin/WorkerPlugin");
...
class RspackOptionsApply {
    ...
    process(options, compiler) {
        ...
        new WorkerPlugin_1.WorkerPlugin(options.output.workerChunkLoading, options.output.workerWasmLoading, options.output.module, options.output.workerPublicPath).apply(compiler);
