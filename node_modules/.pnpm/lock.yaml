...
dependencies:
  '@rspack/cli':
    specifier: latest
    version: 0.4.3(@rspack/core@0.4.3)(webpack-cli@5.1.4)
  '@rspack/core':
    specifier: latest
    version: 0.4.3
  html-webpack-plugin:
...
packages:
  ...
  /@rspack/cli@0.4.3(@rspack/core@0.4.3)(webpack-cli@5.1.4):
    resolution: {integrity: sha512-2s159uLRr/lX5S2Xifaj6DvQG8ajIOZwXyBf3OlvaGb8miFVLHjBL7TBu6vq3SNXOY9cjIK67B9AIMBZZPENjA==}
    hasBin: true
    peerDependencies:
      '@rspack/core': '>=0.4.0'
    dependencies:
      '@discoveryjs/json-ext': 0.5.7
      '@rspack/core': 0.4.3
      '@rspack/dev-server': 0.4.3(@rspack/core@0.4.3)(webpack-cli@5.1.4)
      colorette: 2.0.19
      exit-hook: 3.2.0
      interpret: 3.1.1
      rechoir: 0.8.0
  ...
  /@rspack/dev-server@0.4.3(@rspack/core@0.4.3)(webpack-cli@5.1.4):
    ...
    dependencies:
      ...
      webpack-dev-server: 4.13.1(webpack-cli@5.1.4)(webpack@5.76.0)
      ws: 8.8.1
    transitivePeerDependencies:
      - '@swc/core'
      - '@types/express'
